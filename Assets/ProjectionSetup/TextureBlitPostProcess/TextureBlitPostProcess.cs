...
[Serializable, VolumeComponentMenuForRenderPipeline("Custom/TextureBlitPostProcess", typeof(UniversalRenderPipeline))]
public sealed class TextureBlitPostProcess : VolumeComponent, IPostProcessComponent
{
    ...
    public bool IsActive() => textureToBlit1.value != null && textureToBlit2.value != null && textureToBlit3.value != null && textureToBlit4.value != null;
